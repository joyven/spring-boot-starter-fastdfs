package org.springframework.fasfdfs.server;
...
import org.springframework.fasfdfs.exception.FdfsError;
...
public class FastDFSClient {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithMultipart(MultipartFile file) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithMultipart(MultipartFile file, Map<String, String> descriptions) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithFilepath(String filepath) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithFilepath(String filepath, Map<String, String> descriptions) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64, String filename) throws FdfsException {
     ...
     * @return 返回上传成功后的文件路径
     */
    public String uploadFileWithBase64(String base64, String filename, Map<String, String> descriptions) throws FdfsException {
     ...
     * @param descriptions 文件描述信息
     * @return 文件路径
     * @throws FdfsException file为空则抛出异常
     */
    public String upload(MultipartFile file, Map<String, String> descriptions) throws FdfsException {
        if (file == null || file.isEmpty()) {
            throw new FdfsException(FdfsError.FILE_ISNULL.getCode(), FdfsError.FILE_ISNULL.getMessage());
        }
        String path = null;
        try {
     ...
     * @param descriptions 文件描述
     * @return 文件路径
     * @throws FdfsException 文件路径为空则抛出异常
     */
    public String upload(String filepath, Map<String, String> descriptions) throws FdfsException {
        if (StringUtils.isBlank(filepath)) {
            throw new FdfsException(FdfsError.FILE_PATH_ISNULL.getCode(), FdfsError.FILE_PATH_ISNULL.getMessage());
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new FdfsException(FdfsError.FILE_NOT_EXIST.getCode(), FdfsError.FILE_NOT_EXIST.getMessage());
        }
     ...
     * @param descriptions 文件描述信息
     * @return 文件路径
     * @throws FdfsException base64为空则抛出异常
     */
    public String upload(String base64, String filename, Map<String, String> descriptions) throws FdfsException {
     ...
     */
    public String upload(InputStream is, String filename, Map<String, String> descriptions) throws FdfsException {
        if (is == null) {
            throw new FdfsException(FdfsError.FILE_ISNULL.getCode(), FdfsError.FILE_ISNULL.getMessage());
        }
        ...
        try {
            if (is.available() > maxFileSize) {
                throw new FdfsException(FdfsError.FILE_OUT_SIZE.getCode(), FdfsError.FILE_OUT_SIZE.getMessage());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            if (StringUtils.isBlank(path)) {
                throw new FdfsException(FdfsError.FILE_UPLOAD_FAILED.getCode(), FdfsError.FILE_UPLOAD_FAILED.getMessage());
            }
     ...
     * @param response
     */
    public void downloadFile(String filepath, HttpServletResponse response) throws FdfsException {
     ...
     * @param os       输出流
     */
    public void downloadFile(String filepath, OutputStream os) throws FdfsException {
     ...
     */
    public void downloadFile(String filepath, String filename, HttpServletResponse response) throws FdfsException {
     ...
     * @param response HttpServletResponse
     */
    public void download(String filepath, String filename, OutputStream os, HttpServletResponse response) throws FdfsException {
        if (StringUtils.isBlank(filepath)) {
            throw new FdfsException(FdfsError.FILE_PATH_ISNULL.getCode(), FdfsError.FILE_PATH_ISNULL.getMessage());
        }
        ...
        try {
            ...
            e.printStackTrace();
            throw new FdfsException(FdfsError.FILE_DOWNLOAD_FAILED.getCode(), FdfsError.FILE_DOWNLOAD_FAILED.getMessage());
        } finally {
            // 关闭流
            try {
                if (is != null) {
     ...
     * @throws FdfsException
     */
    public byte[] download(String filepath) throws FdfsException {
        if (StringUtils.isBlank(filepath)) {
            throw new FdfsException(FdfsError.FILE_PATH_ISNULL.getCode(), FdfsError.FILE_PATH_ISNULL.getMessage());
        }
     ...
     */
    public int deleteFile(String filepath) throws FdfsException {
        if (StringUtils.isBlank(filepath)) {
            throw new FdfsException(FdfsError.FILE_PATH_ISNULL.getCode(), FdfsError.FILE_PATH_ISNULL.getMessage());
        }
        ...
        try {
            ...
            if (success != 0) {
                throw new FdfsException(FdfsError.FILE_DELETE_FAILED.getCode(), FdfsError.FILE_DELETE_FAILED.getMessage());
            }
        } catch (IOException e) {
            e.printStackTrace();
        } catch (MyException e) {
     ...
     * @return 文件描述信息
     */
    public Map<String, Object> getFileDescriptions(String filepath) throws FdfsException {
        TrackerServer trackerServer = pool.borrowObject();
        StorageClient1 storageClient = new StorageClient1(trackerServer, null);
        NameValuePair[] nvps = null;
        try {
     ...
     * @return 文件名称
     */
    public String getOriginalFilename(String filepath) throws FdfsException {
